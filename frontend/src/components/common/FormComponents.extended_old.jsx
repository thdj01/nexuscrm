...
// ─────────────────────────────────────────────────────────────────────────────
export const StepProgressBar = ({ steps = [], currentStep = 0, onStepClick }) => {
  ...
  return (
    <div className="w-full min-w-0 max-w-full">
      <div
        ref={scrollRef}
        className="relative flex flex-nowrap items-center gap-x-1.5 overflow-x-auto scroll-smooth px-1 py-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden xl:flex-wrap xl:justify-end xl:gap-y-1 xl:overflow-visible"
      >
        {steps.map((step, i) => {
